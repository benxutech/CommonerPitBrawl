...
ds_list_add(feats[0], 'Wealthy', 'Swift', 'Tactician', 'Enduring', 'Long Description', 'Wrap test');
...
ds_map_add(feats[1], 'Long Description', 'Extra long description. Extra long description.Extra long description.  ');

ds_map_add(feats[1], 'Wrap test', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa');
return feats;
